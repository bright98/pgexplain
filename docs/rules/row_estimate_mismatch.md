...
- **[SortSpill](sort_spill.md)** — a row estimate underestimate on the input to a Sort node can cause work_mem to be under-allocated, making a disk spill more likely even with a reasonable global setting.
